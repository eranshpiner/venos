 ...
 * @param {*} result
 */
function orderRecordResultTranslator(result) {
 ...
 * @param {*} order
 */
function orderRecordBuilder (order) {
  return {
    orderId: uuid(),
    total: order.total,
...
function orderItemsBuilder(orderId, order) {
...
function orderLogBuilder(order, transaction, pos) {
  return {
...
function logBuilder(order, orderLog, result, error) {
